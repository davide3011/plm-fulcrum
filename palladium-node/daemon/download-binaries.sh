...
usage(){ echo "Usage: ./download-binaries.sh [--platform linux|darwin|windows] [--arch x86_64|aarch64|armv7l] [--repo owner/name] [--outdir /path]"; }
...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    --outdir) [[ $# -ge 2 ]] || die "Missing value for --outdir"; dir="$2"; shift 2 ;;
    -h|--help) usage; exit 0 ;;
